...
public final class Constants {
  ...
  public static final class FuelConstants {
    ...
    public static final int LEFT_INTAKE_LAUNCHER_MOTOR_ID = 2;
    public static final int RIGHT_INTAKE_LAUNCHER_MOTOR_ID = 3;
    public static final int INDEXER_MOTOR_ID = 9;

    // Current limit for fuel mechanism motors.
    public static final int INDEXER_MOTOR_CURRENT_LIMIT = 70;
    public static final int LAUNCHER_MOTOR_CURRENT_LIMIT = 70;

    // All values likely need to be tuned based on your robot
    public static final double INDEXER_INTAKING_PERCENT = -1; 
    public static final double INDEXER_LAUNCHING_PERCENT = 1;
    public static final double INDEXER_SPIN_UP_PRE_LAUNCH_PERCENT = 1;

    public static final double INTAKE_INTAKING_PERCENT = 1;
